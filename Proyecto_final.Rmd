...
```{r, echo = FALSE, message = FALSE, fig.cap = "Puntaje de felicidad a lo largo de los años por paises, por continente, en rojo el promedio de puntaje de felicidad por continente"}
 base_felicidad%>%
          group_by(anio, continente)%>%  
