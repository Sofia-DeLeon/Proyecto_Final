...
```{r, echo = FALSE, fig.cap = "Puntaje de felicidad para algunos paises de Sudamérica a lo largo de los años"}
felicidad %>%
     group_by(pais) %>% 
...
```{r, echo = FALSE, fig.cap = "Puntaje promedio de felicidad para algunos paises de Sudamérica"}
felicidad %>%
     group_by(pais) %>% 
...
## En este caso podemos observar que el país que tiene más afecto negativo es Syria y lo obtuvo en el año 2012. 
